...
function viaNcbiProxy(url: string) {
  // SAME ORIGIN: works on Vercel and local dev (Vite will serve /api from Vercel only in prod;
  // locally you can run `vercel dev` or provide your own local proxy if needed).
